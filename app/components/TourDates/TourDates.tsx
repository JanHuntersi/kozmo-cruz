	...
	return (
		<div >
			{data.map((gig: TourDate, index:number) => (
				...
				>
					<div className="flex flex-col items-end justify-between text-center text-base leading-none w-[40%] md:text-xl lg:w-6/12 lg:flex-row lg:justify-start lg:text-left lg:text-2xl">
