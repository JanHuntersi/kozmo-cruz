  ...
  */
  ...
  return react_1["default"].createElement("ul", {
    ...
    return react_1["default"].createElement("li", {
      ...
      className: "flex flex-col items-center justify-between text-center text-base leading-none w-[40%] md:text-xl lg:w-6/12 lg:flex-row lg:justify-start lg:text-left lg:text-2xl"
    }, react_1["default"].createElement("div", {
