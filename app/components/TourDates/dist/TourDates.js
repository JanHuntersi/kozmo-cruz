...
function TourDates(_a) {
    var data = _a.data;
    return (react_1["default"].createElement("ul", { className: "list-none" }, data.map(function (gig, index) { return (react_1["default"].createElement("li", { key: index, className: "flex items-center justify-between py-2 border-solid border-b-2 border-white last:border-b-0 leading-tight text-xl md:py-3 md:text-2xl lg:py-5 lg:justify-center lg:text-2xl xl:text-3xl lg:flex-row" },
        react_1["default"].createElement("div", { className: "flex flex-col items-center justify-between text-center text-base leading-none w-[40%] md:text-xl lg:w-6/12 lg:flex-row lg:justify-start lg:text-left lg:text-2xl" },
            ...
            (gig.start_time_text || gig.event_date) && (react_1["default"].createElement("div", { className: " text-white font-semibold leading-tight lg:ml-[20%]" },
                react_1["default"].createElement("p", null, gig.day_of_week),
                react_1["default"].createElement("p", null, gig.start_time_text)))),
